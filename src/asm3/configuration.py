...
def onlineform_spam_mandatory(dbo: Database) -> bool:
    return cboolean(dbo, "OnlineFormSpamMandatory", DEFAULTS["OnlineFormSpamMandatory"] == "Yes")
...
def unit_extra(dbo: Database, newval: str = None) -> str:
    """ 
