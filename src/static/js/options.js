            ...
            return [
                ...
                tableform.render_tabs([
                    { id: "tab-shelterdetails", title: _("Shelter Details"), fields: [
                        ...
                        { type: "rowclose" },
                        { id: "workhours", post_field: "DefaultShiftStart", label: _("Working hours"), type: "text",
                            classes: "asm-textbox asm-halftextbox asm-timebox",
                            xmarkup: '<input id="workhoursend" data-post="DefaultShiftEnd" type="text" class="asm-textbox asm-halftextbox asm-timebox" />' },
                    ...
                    { id: "tab-animalemblems", title: _("Animal Emblems"), fields: [
                        ...
                        { id: "showfutureadoption", post_field: "EmblemFutureAdoption", label: html.icon("movement") + " " + _("Future Adoption"), type: "check" },
                        { id: "showhold", post_field: "EmblemHold", label: html.icon("hold") + " " + _("Hold"), type: "check" },
                    ...
                    { id: "tab-defaults", title: _("Defaults"), info:_("These are the default values for these fields when creating new records."), fields: [
                        ...
                        { id: "defaultshift", post_field: "DefaultShiftStart", label: _("Default Rota Shift"), type: "text", classes: "asm-textbox asm-halftextbox asm-timebox", xmarkup: '<input id="defaultshiftend" data-post="DefaultShiftEnd" type="text" class="asm-textbox asm-halftextbox asm-timebox" />' }, 
                    ...
                    { id: "tab-logs", title: _("Logs"), fields: [
                        ...
                        { id: "personflagchangelog", post_field: "PersonFlagChangeLog", label: _("When I change the flags on a person, make a note of it in the log with this type"), type: "check", xmarkup: ' <select data="PersonFlagChangeLogType" id="personflagchangelogtype" class="asm-selectbox">' + html.list_to_options(controller.logtypes, "ID", "LOGTYPENAME") + '</select>' }, 
                    ...
                    { id: "tab-reminders", title: _("Reminder Emails"), info: _("Reminder emails can be automatically sent to groups of people a number of days before or after a key event."), fields: [
                        ...
                        { id: "vaccinationreminder", post_field: "EmailVaccinationReminder", label: _("Send a reminder email to owners X days before a vaccination is due"), type: "check", xmarkup: '</td><td><input data="EmailVaccinationReminderDays" id="vaccinationreminderdays" data-min="0" data-max="365" class="asm-textbox asm-numberbox" /></td><td><select data="EmailVaccinationReminderTemplate" class="asm-selectbox">' + edit_header.template_list_options(controller.templates) + '</select>' }, 
